            ...
            >
                ...
                <SwiperSlide>
                    ...
                    >
                        ...
                        {/* Content Over the Overlay */}
                        <div data-aos="fade-right" className='text-white flex flex-col md:flex-row md:items-center justify-between md:px-30 py-10 gap-5'>
                            <div
                                data-aos="fade-right"
                                data-aos-offset="200"
                                data-aos-mirror="true"
                            ...
                            <div className='max-w-[100vw] md:w-1/2  p-6'>
                                <img src={banner1} alt="" className='rounded-2xl h-[280px]' />
                            </div>
                        </div>
                        <div>
                            <div>
                ...
                <SwiperSlide>
                    <div
                        style={{ backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' version='1.1' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns:svgjs='http://svgjs.dev/svgjs' width='1450' height='700' preserveAspectRatio='none' viewBox='0 0 1450 700'%3e%3cg mask='url(%26quot%3b%23SvgjsMask1010%26quot%3b)' fill='none'%3e%3crect width='1450' height='700' x='0' y='0' fill='rgba(15%2c 23%2c 43%2c 1)'%3e%3c/rect%3e%3cpath d='M1609.25 479.77C1465.78 481.01 1358.16 637.91 1054.48 626.77 750.8 615.63 702.73 45.75 499.71-16.64' stroke='rgba(51%2c121%2c194%2c0.58)' stroke-width='2'%3e%3c/path%3e%3cpath d='M1651.82 540.68C1507.16 534.19 1382.1 330.09 1130.29 288.68 878.47 247.27 977.39-62.15 869.52-115.09' stroke='rgba(51%2c121%2c194%2c0.58)' stroke-width='2'%3e%3c/path%3e%3cpath d='M1568.88 58.76C1422.02 66.86 1311.24 332.2 1047.7 331.76 784.17 331.32 693.4-72 526.53-98.58' stroke='rgba(51%2c121%2c194%2c0.58)' stroke-width='2'%3e%3c/path%3e%3cpath d='M1480.55 124.38C1357.97 124.03 1239.32 36.88 998.08 36.88 756.85 36.88 757.65 124.45 515.61 124.38 273.57 124.31 160.7-39.63 33.14-41.94' stroke='rgba(51%2c121%2c194%2c0.58)' stroke-width='2'%3e%3c/path%3e%3cpath d='M1553.01 215.15C1414.48 226.84 1325.12 511.25 1080.99 509.15 836.87 507.05 781.23 17.66 608.98-34.66' stroke='rgba(51%2c121%2c194%2c0.58)' stroke-width='2'%3e%3c/path%3e%3c/g%3e%3cdefs%3e%3cmask id='SvgjsMask1010'%3e%3crect width='1450' height='700' fill='white'%3e%3c/rect%3e%3c/mask%3e%3c/defs%3e%3c/svg%3e")`, backgroundSize: 'cover' }}
                        className='relative h-[809px] @8xl:h-[1020px]'
                    >
                        {/* Overlay */}
                        <div className="absolute inset-0"></div>
